...
if (tools == undefined) var tools = new Object();
...
tools.xilinx = {
    init: function (args) {
        ...
        if (args == undefined) {
            if (
                tools.xilinx.ModuleName == undefined ||
        ...
        if (args["pathISETools"] == undefined) {
            if (org.reflect.xilinx.XilinxDefs.pathISETools == null)
                ...
                console.log(
                    "Using pathISETools: " +
                        org.reflect.xilinx.XilinxDefs.pathISETools +
                        " as default."
                );
        } else
            org.reflect.xilinx.XilinxDefs.pathISETools = args["pathISETools"];
    ...
    xst: function (args) {
        ...
        new org.reflect.xilinx.Report().getXSTReportStr(
            rt.workingFolderStr,
            "function",
            ModuleName
        );
